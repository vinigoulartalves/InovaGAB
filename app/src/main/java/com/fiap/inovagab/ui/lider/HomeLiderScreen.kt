...
fun HomeLiderScreen(
    ...
    Column(
        ...
        Column(
            ...
            HomeMenuButton(text = "Gerenciar orientações", onClick = onGerenciarOrientacoes)
            HomeMenuButton(text = "Ver projetos", onClick = onVerProjetos)
            HomeMenuButton(text = "Dashboard", onClick = onDashboard)
